...
import AnnouncemetStatisticsPageStyle from "./style";
...
const AnnouncementStatisticsPage = (props: PageProps) => {
  const {} = props;
  ...
  return (
    <AnnouncemetStatisticsPageStyle>
      <UserPageCont
        title={t("statistic")}
        has_data={true}
        slider={sliderData}
...
export default AnnouncementStatisticsPage;
