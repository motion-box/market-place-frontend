...
import MFinishAnnouncementPageStyle from "./style";
...
const data: BoosterCardModel[] = [
  {
    ...
    route: "/mobile/boost_announcement/turbo?product_id=0",
  },
  {
    id: 1,
    icon: "TimeBigIcon",
    ...
    price: "one_thd_sum_per_hour",
    route: "/mobile/boost_announcement/in_fifteen_minutes?product_id=0",
  },
];

const MFinishAnnouncementPage = (props: PageProps) => {
  const {} = props;
  ...
  return (
    <MFinishAnnouncementPageStyle>
      <div className="top_cont">
        <h1 className="title">{t("sell_product_faster")}</h1>
        <p className="description">{t("sell_product_faster_description")}</p>
      </div>
...
export default MFinishAnnouncementPage;
